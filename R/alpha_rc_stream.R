...
#' [evaluate_alpha_efficiency()] on the returned `field_book`. To search for
#' an optimised design using Random Restart, Simulated Annealing, or a Genetic
#' Algorithm, call [optimize_alpha_rc()].
#'
#' @details
#' ## Design structure
#'
...
#' }
#'
#' @seealso [evaluate_alpha_efficiency()] to compute A, D, and CDmean
#'   optimality criteria on the returned `field_book`.
#'   [optimize_alpha_rc()] to search for a criterion-optimal design using

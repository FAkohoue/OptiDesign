...
#
# Used as a fallback in evaluate_alpha_efficiency() when the sparse Cholesky
...
#
# Used in evaluate_alpha_efficiency() to compute the D-criterion:
...
#
# Used in evaluate_alpha_efficiency() for the FIXED_TREATMENT_BLUE_CONTRAST
# computation mode.
#
# Arguments:
...
#
# Used in evaluate_alpha_efficiency() to extract submatrices of C^{-1}
...
# evaluate_alpha_efficiency() for AR1 and AR1xAR1 residual structures:
#
...
#
# Notes:
#   The function does not validate rho. The caller (evaluate_alpha_efficiency)
...
# is large (>= eff_full_max in evaluate_alpha_efficiency). This estimator
...
#
# Used in evaluate_alpha_efficiency() for the _APPROX computation modes
...
#
# Used in evaluate_alpha_efficiency() via .trace_subinv_est() for the
